...
f1 = open("pear-corr-iuf/pear_corr_iuf_result5.txt", "w")       # predictions for result5.txt
...
f2 = open("pear-corr-iuf/pear_corr_iuf_result10.txt", "w")      # predictions for result10.txt
...
f3 = open("pear-corr-iuf/pear_corr_iuf_result20.txt", "w")      # predictions for result20.txt
