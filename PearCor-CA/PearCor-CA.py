...
f1 = open("PearCor-CA/PearCor-CA-result5.txt", "w")       # predictions for result5.txt
...
f2 = open("PearCor-CA/PearCor-CA-result10.txt", "w")      # predictions for result10.txt
...
f3 = open("PearCor-CA/PearCor-CA-result20.txt", "w")      # predictions for result20.txt
